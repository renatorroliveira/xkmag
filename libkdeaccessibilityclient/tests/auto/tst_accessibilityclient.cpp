...
void AccessibilityClientTest::tst_characterExtents()
{
    ...
    QCOMPARE(textWord, QString(QLatin1String("This")));
    QCOMPARE(start, 0);
    QCOMPARE(end, 4);
    textWord = textArea.textWithBoundary(6, AccessibleObject::WordStartBoundary, &start, &end);
    QCOMPARE(textWord , QString(QLatin1String("is")));
    QCOMPARE(start, 5);
    QCOMPARE(end, 7);
    ...
    QCOMPARE(textSentence, QString(QLatin1String("This is useless text that is being used to test this text area.")));
    QString textLine = textArea.textWithBoundary(0, AccessibleObject::LineEndBoundary);
    QCOMPARE(textLine, QString(QLatin1String("This is useless text that is being used to test this text area.")));
